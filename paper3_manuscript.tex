...
For verifying the effectiveness of the DSM control scheme, consider the following four-order nonlinear system with the disturbance:
\begin{align}
\dot x_1 &= x_2\\
\dot x_2 &= x_1^3+0.1\sin(20t)+u_1\\
\dot x_3 &= x_4\\
\dot x_4 &= 0.3\sin(3t)+0.5e^{-3t}+u_2,
\end{align}
